...
import { FontSizeOutlined, FileTextOutlined } from "@ant-design/icons";

const { Text } = Typography;

export const Texxt = ({ setPagesWithHistory, openMiniFor }) => {
    ...
    return (
        <>
            ...
            <Row gutter={[12, 12]}>
                <Col span={24}>
                    <Button block type="primary" icon={<FontSizeOutlined />} style={{ height: 50, fontSize: 20, fontWeight: "bold" }}
                ...
                <Col span={24}>
                    <Button block icon={<FileTextOutlined />} style={{ height: 45, fontSize: 16, fontWeight: 500 }}
                ...
                <Col span={24}>
                    <Button block style={{ height: 40, fontSize: 14, fontWeight: 400 }}
                ...
                <Col span={24}>
                    <Button block style={{ height: 35, fontSize: 12, fontWeight: 400 }}
                        ...
                        >
                            {filteredFonts.slice(0, visibleCount).map((font) => (
                                <Button
                                    ...
                                    <Text style={{ fontFamily: font.family, height: 40, fontSize: 14, fontWeight: 400 }}>
                                        {font.family}
                                    </Text>
                                </Button>
                            ))}
