...
import { Button, Card, ColorPicker, Dropdown, Flex, Space, Tooltip, Tour, Typography } from "antd";

import { DeleteOutlined, ReloadOutlined, ZoomInOutlined, ZoomOutOutlined } from "@ant-design/icons";
import { IoDuplicateOutline } from "react-icons/io5";
import { HiOutlinePencil } from "react-icons/hi2";


import { setCollapsed, setEditorPages, setPopUp, setSelectedUniqueId, setZoom } from '../redux/editorReducer';
...
export const Editor = () => {
    ...
    const { path, collapsed, zoom, activeIndex, selectedUniqueId, editorPages, popup, canvasSize } = useSelector((state) => state.editor);
        ...
        <>
            ...
            >
                <PageContainer
                        ...
                        <>
                            <Flex align="center" justify="start" gap={20} wrap style={{ background: "white", padding: 10, borderRadius: 5 }}>
                                ...
                                <Tooltip title="Delete" color="red">
                                    <Button ref={deleteRef} type="link" icon={<DeleteOutlined />} onClick={deleteSelected} style={{ fontSize: 18 }} />
                                </Tooltip>
                    ...
                    footerToolBarProps={{ style: { width: "100%", display: "grid", justifyContent: "center", padding: "10px", overflowX: "auto" } }}
                >
                    <>
